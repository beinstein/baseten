 ...
 *  source code public with my code in it. Though the code has been tested and 
 *  is in use, you use it at your own risk. Some of the features that have been 
 *  put in are for future use and so have not been as rigorously tested as 
 *  actually used features. If you find any bugs or have any problems with any 
 *  of the code then feel free to contact me nathan_day@mac.com.
 */
...
+ (id)runLoopMessengerForCurrentRunLoop
{
	...
	if( theCurentRunLoopMessenger == nil )
		theCurentRunLoopMessenger = [[self alloc] init];
        //tsnorri 20060725
