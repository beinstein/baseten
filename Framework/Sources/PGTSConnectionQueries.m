...
{
    int rval = 0;
    LogQuery (queryString, messageDelegate, nil);
    [connectionLock lock];
   ...
   messageDelegate: (BOOL) messageDelegate
{
    ...
    LogQuery (queryString, messageDelegate, parameters);
    [connectionLock lock];
...
- (int) sendPreparedQuery2: (NSString *) aName parameterArray: (NSArray *) arguments messageDelegate: (BOOL) messageDelegate
{
    ...
    LogQuery (aName, messageDelegate, arguments);
    [connectionLock lock];
