//
// BXPGRelationshipExpressionValueType.h
// BaseTen
//
...
@interface BXPGRelationshipExpressionValueType : BXPGArrayExpressionValueType
{
	NSInteger mRelationshipCardinality;
	BOOL mHasRelationships;
}
