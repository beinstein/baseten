//
// BXPGFunctionExpressionEvaluator.h
// BaseTen
//
...
@interface BXPGFunctionExpressionEvaluator : NSObject
{
}
+ (BXPGExpressionValueType *) valueTypeForExpression: (NSExpression *) expression visitor: (id <BXPGPredicateVisitor>) visitor;
+ (NSString *) evaluateExpression: (BXPGPredefinedFunctionExpressionValueType *) expression 
